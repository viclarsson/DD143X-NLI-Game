...
var ITEM_HAMMER = new Item("Hammer", "A black hammer.");
ROOM_CORRIDOR.addItem(ITEM_HAMMER);

/* = ITEM_BOX = */
var ITEM_BOX = new Item("Box", "A large box is blocking your way into the lecture hall, there might be a way to break it.");
...
var ITEM_NERD = new Item("Nerd", "Some nerd is programming on his Macbook. What a hipster. Better keep it down though, wouldn’t want to disturb him.");
